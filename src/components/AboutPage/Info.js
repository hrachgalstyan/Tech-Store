            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-10 mx-auto col-md-6 my-3">
                        ...
                        <p className="text-lead text-muted my-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil illo ebcaecati non asperiores repellendus alias, nostrum aliquid ad eaque ratione!</p>
                        <p className="text-lead text-muted my-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil illo ebcaecati non asperiores repellendus alias, nostrum aliquid ad eaque ratione!</p>
